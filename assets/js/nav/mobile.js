    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: '' },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: 'row' },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: 'col-xs-12' },
                ...
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3", { className: 'text-center' },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", { className: 'no-deco light', href: `${homeUrl}/events` }, "Events")),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3", { className: 'text-center' },
...
const IndustriesSlide = ({ homeUrl }) => {
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: 'row p-hor-double' },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: 'col-xs-6 p-zero text-center' },
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h4", { className: 'text-center m-top-zero' },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", { className: 'no-deco light', href: `${homeUrl}/about` }, "Automotive"))),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: 'col-xs-6 p-zero text-center' },
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h4", { className: 'text-center m-top-zero' },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", { className: 'no-deco light', href: `${homeUrl}/news` }, "Energy & Environment"))),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: 'col-xs-6 p-zero text-center' },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_icons__WEBPACK_IMPORTED_MODULE_1__.IconOilGas, null),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h4", { className: 'text-center m-top-zero' },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", { className: 'no-deco light', href: `${homeUrl}/career` }, "Oil & Gas"))),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: 'col-xs-6 p-zero text-center' },
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h4", { className: 'text-center m-top-zero' },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", { className: 'no-deco light', href: `${homeUrl}/events` }, "Processing")))));
};
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: className },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "row" },
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", { className: 'no-deco w-full m-zero p-zero', href: `${window.MindGlobal.homeUrl}/contact` },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", { className: 'text-center' }, "Contact")))));
};
