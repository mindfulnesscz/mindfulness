...
/* harmony import */ var _slide_main__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./slide-main */ "./src/nav/components/slide-main.tsx");
/* harmony import */ var _slide_sub__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./slide-sub */ "./src/nav/components/slide-sub.tsx");
/* harmony import */ var _device_slides_slide_about__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./device-slides/slide-about */ "./src/nav/components/device-slides/slide-about.tsx");
/* harmony import */ var _device_slides_slide_industries__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./device-slides/slide-industries */ "./src/nav/components/device-slides/slide-industries.tsx");
/* harmony import */ var _device_slides_slide_solutions__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./device-slides/slide-solutions */ "./src/nav/components/device-slides/slide-solutions.tsx");
/* harmony import */ var _ess_logo__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./ess-logo */ "./src/nav/components/ess-logo.tsx");
/* harmony import */ var _sass_devices_nav_sass__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../sass/devices_nav.sass */ "./src/nav/sass/devices_nav.sass");
/**
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { id: 'wmnav-wrap' },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { id: "wmnav-bar", style: Object.assign({}, headerStyle) },
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { id: 'wm-burger' },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { onClick: navToggle, id: "main-nav-toggler", className: "m-right-base hamburger hamburger--collapse", type: "button", "data-toggle": "top-menu", "aria-label": "hamburger navigation toggle" },
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { id: "wmnav-slides", ref: Slides },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { ref: SlideMain, className: "wmnav-slide", id: "wmnav-slide-main" },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_slide_main__WEBPACK_IMPORTED_MODULE_3__["default"], { className: "wmnav-slide-inner wmnav-main-slide", callSlide: callSlide, slideLinks: slidesArray })),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { ref: SlideAbout, className: "wmnav-slide", id: "wmnav-slide-about" },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_slide_sub__WEBPACK_IMPORTED_MODULE_4__["default"], { title: "About us", className: "wmnav-slide-inner", callSlide: callSlide, slideLinks: [{ name: 'main', el: SlideMain.current }] },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_device_slides_slide_about__WEBPACK_IMPORTED_MODULE_5__["default"], { homeUrl: homeUrl }))),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { ref: SlideIndustries, className: "wmnav-slide", id: "wmnav-slide-industries" },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_slide_sub__WEBPACK_IMPORTED_MODULE_4__["default"], { title: "Industries", className: "wmnav-slide-inner", callSlide: callSlide, slideLinks: [{ name: 'main', el: SlideMain.current }] },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_device_slides_slide_industries__WEBPACK_IMPORTED_MODULE_6__["default"], { homeUrl: homeUrl }))),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { ref: SlideSolutions, className: "wmnav-slide", id: "wmnav-slide-solutions" },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_slide_sub__WEBPACK_IMPORTED_MODULE_4__["default"], { title: "Solutions", className: "wmnav-slide-inner", callSlide: callSlide, slideLinks: [{ name: 'main', el: SlideMain.current }] },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_device_slides_slide_solutions__WEBPACK_IMPORTED_MODULE_7__["default"], { homeUrl: homeUrl, templateUrl: templateUrl }))))));
};
...
const slideMain = ({ className, callSlide, slideLinks }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: className },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "row" },
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: 'w-full center m-vert-base' },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", { className: 'wm-button has-white-color rounded-full center m-auto', href: `${window.MindGlobal.homeUrl}/consult` }, "Get Free Consultation")),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: 'w-full' }),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: 'center m-auto p-top-double' },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", { href: `${window.MindGlobal.homeUrl}/${loggedIn ? 'account' : 'login'}`, className: 'center' }, loggedIn ? 'account' : 'login'),
                loggedIn &&
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: 'inline-block' }, "/"),
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", { className: 'center', href: `${window.MindGlobal.homeUrl}/logout` }, "logout"))))));
};
