...
var index_src = ''; //  CHECKS THE MOBILE VERSUS DESKTOP VERSION 

window.ismobile = false;
if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|BB|PlayBook|IEMobile|Windows Phone|Kindle|Silk|Opera Mini/i.test(navigator.userAgent)) window.ismobile = true;
if (window.innerWidth < 761) window.ismobile = true;
if (
/*@cc_on!@*/
 false || !!document.documentMode) window.ismobile = true;
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendors-node_modules_core-js_modules_es_regexp_exec_js"], () => (__webpack_require__("./src/index.js")))
