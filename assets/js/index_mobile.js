...
/***/ "./src/theme-mindfulness/js/footer-sliders.js":
/*!****************************************************!*\
  !*** ./src/theme-mindfulness/js/footer-sliders.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ FooterSlider)
/* harmony export */ });
...
var FooterSlider = /*#__PURE__*/function () {
  function FooterSlider(slider, settings) {
    _classCallCheck(this, FooterSlider);
  ...
  _createClass(FooterSlider, [{
    ...
    value: function init() {
      ...
      if (this.slides) {
        ...
        if (!this.curr_el.classList.contains('curr')) this.curr_el.classList.add('curr');
        ...
        if (this.settings.center_arrows) this.__position_arrows();
        window.addEventListener('resize', function () {
          _this.__position_arrows();
        });
    ...
    key: "__get_arrow",
    value: function __get_arrow(direction) {
    ...
    key: "__get_width",
    value: function __get_width() {
      return this.el_slider.parentElement.offsetWidth;
    }
  }, {
    key: "__get_slides",
    value: function __get_slides() {
      return this.el_slider.getElementsByClassName('slide');
    }
  }, {
    key: "__get_next_slide_number",
    value: function __get_next_slide_number() {
      if (parseInt(this.int_curr) + 1 == this.slides_length) return 0;else return this.int_curr + 1;
    }
  }, {
    key: "__get_prev_slide_number",
    value: function __get_prev_slide_number() {
      if (parseInt(this.int_curr) == 0) {
        return this.slides.length - 1;
      } else return this.int_curr - 1;
    }
  }, {
    key: "__next",
    value: function __next() {
      ...
      var int_next = this.__get_next_slide_number();

      this.next_el = this.slides[int_next];
      this.next_el.classList.add('next');
      this.int_curr = int_next; // sets the new current number

      gsap__WEBPACK_IMPORTED_MODULE_7__["default"].to(this.el_slider, this.velocity, {
        left: '-100%',
    ...
    key: "__next_callback",
    value: function __next_callback() {
      this.__reset_slider();
    ...
    key: "__prev",
    value: function __prev() {
      this.__preset_slider();

      this.el_slider.style.left = '-100%';

      var int_prev = this.__get_prev_slide_number();
    ...
    key: "__position_arrows",
    value: function __position_arrows(arrow) {
      var _this2 = this;

      this.arrows.forEach(function (arrow_item) {
        arrow_item.style.top = _this2.el_slider.offsetHeight / 2 - arrow_item.offsetHeight / 2 + 'px';
      });
    }
  }, {
    key: "__prev_callback",
    value: function __prev_callback() {
      this.__reset_slider();
    ...
    key: "__preset_slider",
    value: function __preset_slider() {
...
/***/ "./src/theme-mindfulness/js/forms.js":
/*!*******************************************!*\
  !*** ./src/theme-mindfulness/js/forms.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/theme-mindfulness/js/helpers.js":
/*!*********************************************!*\
  !*** ./src/theme-mindfulness/js/helpers.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/theme-mindfulness/js/mind-helpers/MindCookies.js":
/*!**************************************************************!*\
  !*** ./src/theme-mindfulness/js/mind-helpers/MindCookies.js ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/theme-mindfulness/js/reveal.js":
/*!********************************************!*\
  !*** ./src/theme-mindfulness/js/reveal.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ EssReveals)
/* harmony export */ });
...
var EssReveals = /*#__PURE__*/function () {
  function EssReveals() {
    _classCallCheck(this, EssReveals);
  }

  _createClass(EssReveals, null, [{
    key: "activate",
    value: function activate() {
      var _this = this;

      var horiveals = document.querySelectorAll('.ess-horizontal-reveal');
      document.EssActiveObject = null;
      document.addEventListener('click', this.hideReveal);

      var _loop = function _loop(i) {
        var rev = horiveals[i];
        var trigger = rev.getAttribute('trigger');
        var h = rev.firstElementChild.offsetHeight;
        var trigerdiv = document.getElementById(trigger);
        var TO = {
          totrigger: trigerdiv,
          todiv: rev,
          todir: 'height',
        ...
        trigerdiv.addEventListener('click', function () {
          if (trigerdiv.classList.contains("ess-active") == true) {
            _this.deatcivateReveal(TO);
          } else _this.activateReveal(TO);
        });
      };

      for (var i = 0; i < horiveals.length; i++) {
        _loop(i);
      }
    }
  }, {
    key: "activateReveal",
    value: function activateReveal(reveal_obj) {
      var _gsap$to;

      console.log('activating');
      document.EssActiveObject = reveal_obj;
      console.log(reveal_obj);
      gsap__WEBPACK_IMPORTED_MODULE_1__["default"].to(reveal_obj.todiv, (_gsap$to = {
        duration: 0.2
      }, _defineProperty(_gsap$to, reveal_obj.todir, reveal_obj.toval), _defineProperty(_gsap$to, "opacity", 1), _gsap$to));
      reveal_obj.totrigger.classList.toggle("ess-active");
    }
  }, {
    key: "deatcivateReveal",
    value: function deatcivateReveal(reveal_obj) {
      ...
      if (reveal_obj) {
        ...
        gsap__WEBPACK_IMPORTED_MODULE_1__["default"].to(reveal_obj.todiv, (_gsap$to2 = {
          duration: 0.2
        }, _defineProperty(_gsap$to2, reveal_obj.todir, 0), _defineProperty(_gsap$to2, "opacity", 0), _gsap$to2));
        reveal_obj.totrigger.classList.toggle("ess-active");
      }
    }
  }, {
...
"use strict";
/*!***********************************************!*\
  !*** ./src/theme-mindfulness/index_mobile.js ***!
  \***********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _js_reveal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./js/reveal */ "./src/theme-mindfulness/js/reveal.js");
/* harmony import */ var _js_footer_sliders__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./js/footer-sliders */ "./src/theme-mindfulness/js/footer-sliders.js");
/* harmony import */ var _js_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./js/forms */ "./src/theme-mindfulness/js/forms.js");
...
/* harmony import */ var _js_helpers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./js/helpers */ "./src/theme-mindfulness/js/helpers.js");
/* harmony import */ var _js_mind_helpers_MindCookies__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./js/mind-helpers/MindCookies */ "./src/theme-mindfulness/js/mind-helpers/MindCookies.js");
/*jshint esversion: 6 */
...
(0,_js_helpers__WEBPACK_IMPORTED_MODULE_4__.mind_global)();
window.MindCookiesHandler = new _js_mind_helpers_MindCookies__WEBPACK_IMPORTED_MODULE_5__["default"]('./');
...
window.ess_index = function () {
  ...
  for (var i = 0; i < imgs.length; i++) {
    var img = imgs[i];
    if (img.getAttribute('src') == '') img.parentNode.removeChild(img);
    console.log('removing');
  } //----------------------- SAME IN INDEX_DESKTOP ----------------------------------


  (0,_js_helpers__WEBPACK_IMPORTED_MODULE_4__.mind_global)();
  window.MindCookiesHandler = new _js_mind_helpers_MindCookies__WEBPACK_IMPORTED_MODULE_5__["default"]('./'); // form formating

  (0,_js_forms__WEBPACK_IMPORTED_MODULE_2__["default"])({}); // Footer sliders

  var news_footer_slider = new _js_footer_sliders__WEBPACK_IMPORTED_MODULE_1__["default"](document.getElementById('ess-news-slider'), {});
  news_footer_slider.init();
  var events_footer_slider = new _js_footer_sliders__WEBPACK_IMPORTED_MODULE_1__["default"](document.getElementById('ess-events-slider'), {});
  events_footer_slider.init();
  _js_reveal__WEBPACK_IMPORTED_MODULE_0__["default"].activate(); // Materialize

  var elems = document.querySelectorAll('select');
  var instances = M.FormSelect.init(elems, {});
  var collapsibles = document.querySelectorAll('.collapsible');
  var collapsibles_inst = M.Collapsible.init(collapsibles, {});
  var instance = M.Tabs.init(document.querySelectorAll('.tabs'), {}); //----------------------- END OF SAME CONTENT  ----------------------------------

  var ess_sidenav = document.getElementById('ess-side-menu');
  var el_toggle = document.getElementById('ess-menu-toggle');
  this.M.Sidenav.init(ess_sidenav, {});
  var menu_inst = M.Sidenav.getInstance(ess_sidenav);
  var hb = document.querySelector('#homepage-banner');
  if (hb) hb.style.display = 'block';
  window.homepage_banner = new _js_footer_sliders__WEBPACK_IMPORTED_MODULE_1__["default"](document.getElementById('ess-home-banner-classic'), {
    autoplay: true,
    center_arrows: true
  });
  window.homepage_banner.init();
  el_toggle.classList.remove('ess-hidden');
  el_toggle.addEventListener('click', function () {
    menu_inst.open();
  });
};
})();
