...
const DeviceNavComponent = ({ templateUrl }) => {
...
react_dom__WEBPACK_IMPORTED_MODULE_1___default().render(react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_device_nav_device_nav_component__WEBPACK_IMPORTED_MODULE_2__["default"], { templateUrl: mindConstants.templateUrl }), document.querySelector('#wm-device-nav'));
