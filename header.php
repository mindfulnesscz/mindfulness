...
<body id="ess-body" class="ess-body-frontend<?php echo ((is_front_page() ? ' ess-homepage' : '')); ?><?php echo ((is_page_template('page-consult-landing.php') || mindfulness_is_revamp_template()) ? ' ess-nav-on-dark' : ''); ?>">
