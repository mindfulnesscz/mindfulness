		...
		<div id="csscube-cont">
			...
			<div id="csscube-scene">
				<button class="csscube-navbutton left-button">
					...
					<!--<img src="<?php  echo $template_url.'/theme-mindfulness/assets/images/cube_arrow_left.png'; ?>">-->
				</button>
				<button class="csscube-navbutton right-button">
				 <span class="ess-icon color-primary big-icon icon_simple_arrow_right"></span>
				 <!--<img src="<?php  echo $template_url.'/theme-mindfulness/assets/images/cube_arrow_right.png'; ?>">-->
				</button>
						...
						<div id="csscube-back">
							...
							<div class="css_block w_iii h_v x_o y_ii css-white product-block main-product-block">
								<a href="<?php echo home_url();?>/alsim-cloud">
									<img class="main-product-logo" src="<?php echo $template_url; ?>/theme-mindfulness/assets/images/product-logos/logo_cloud.svg" >
									<h4>alsim</h4>
									<h3>CLOUD</h3>
								</a>
							</div>
							...
							<a href="<?php echo home_url();?>/alsim-platform">
									<img class="main-product-logo" src="<?php echo $template_url;?>/theme-mindfulness/assets/images/product-logos/logo_platform.svg" >
									<h4>alsim</h4>
									<h3>PLATFORM</h3>
								</a>
							</div>
							...
							<a href="<?php echo home_url();?>/alsim-services">
									<img class="main-product-logo" src="<?php echo $template_url;?>/theme-mindfulness/assets/images/product-logos/logo_services.svg" >
									<h4>alsim</h4>
									<h3>SERVICES</h3>
								</a>
							</div>
						...
						<div id="csscube-bottom">
							<div class="css_block w_xii h_v x_o y_o css-grey-lighter">
								<a href="<?php echo home_url(); ?>">
									<img style="max-height: 80%;" src="<?php  echo get_template_directory_uri().'/theme-mindfulness/assets/images/ess_logo.svg'; ?>">
								</a>
							</div>
							...
							<div class="css_block w_vi h_iii x_o y_v css-grey-lighter">
								<a href="<?php echo home_url().'/about-us'?>">
									<!--<img style="height: 60%; width: auto;" src="<?php echo get_template_directory_uri().'/theme-mindfulness/assets/images/logo_image_ess.svg'?>">-->
									<h2>About us</h2>
								</a>
							</div>
	...
	<div id="ess-main-container">
		...
		<ul id="ess-side-menu" class="sidenav">
			<li id="ess-side-logo">
				...
				<a href="<?php echo home_url()?>"><img src="<?php echo $template_url ?>/theme-mindfulness/assets/images/side-logo.svg">
				</a>
