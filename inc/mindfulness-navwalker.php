...
/**
 * Class Name: ESS_Collapse_Walker
 * Description: A custom WordPress nav walker class for Mindfulness WP Theme
 * Version: 0.2
 * Author: Webmind
 */
class ESS_Collapse_Walker extends Walker_Nav_Menu
{
  ...
  public function start_lvl(&$output, $depth = 0, $args = array())
  {
    ...
    if ($depth === 0)
      $collapse_block =  sprintf('<div class="collapsible-body"><ul id="%s" class=" nav collapse %s" aria-labelledby="link_%s" role="tabpanel">', $collapse_id, $collapse_in_class, $collapse_id);
    else
  ...
  public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0)
  {
    ...
    if ($this->parent_item_depth !== $depth || $this->parent_item_id !== $item->ID) {
      ...
      $class_names .= ($this->parent_has_current_child ? ' active' : '');
      ...
      if ($depth === 0) {
        $atts['class'] = 'nav-link collapsible-header ';
      } elseif ($depth > 0) {
