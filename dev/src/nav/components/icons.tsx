...
export const ArrowLeft: React.FC<Props> = ( {className} ) => {
  ...
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 150 150">
      <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="-5601.8457" y1="65.0332" x2="-5499.1792" y2="65.0332" gradientTransform="matrix(-1 0 0 1 -5479.1777 0)">
        <stop  offset="0" style={{stopColor:'#14BEF0'}}/>
        <stop  offset="1" style={{stopColor:'#15A1FF'}}/>
      </linearGradient>
      ...
      <path className="cbarr-2" d="M67,86.2v26.6l55.6-60.2L67,16.8v23.4c0,0-47,12.3-47,25.8s0,47.1,0,47.1S21.1,94.6,67,86.2z"/>
...
export const ArrowRight: React.FC<Props> = ( {className} ) => {
  ...
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 150 150">
      <polygon className="cbarr-0" points="20,54.6 76.6,18.4 83.7,16.8 28.1,52.7 "/>
      <polygon className="cbarr-1" points="28.1,52.7 83.7,112.9 73,112.9 65.6,104.7 20,54.6 "/>

      <path className="cbarr-2" d="M83.7,86.2v26.6L28.1,52.7l55.6-35.8v23.4c0,0,47,12.3,47,25.8s0,47.1,0,47.1S129.6,94.6,83.7,86.2z"/>
      <path className="cbarr-3" d="M118.5,114.6c0-0.2,0.1-0.4,0.1-0.6C118.5,114.2,118.5,114.4,118.5,114.6z"/>
      <path className="cbarr-1" d="M118.5,114.6c0-0.2,0.1-0.4,0.1-0.6c0-7.4-17.1-17.3-34.8-19.7c0,0,0-1.7,0-3.5c0-1.8,0-3.7,0-4.6
	...
	C82.9,128.2,117.2,124.6,118.5,114.6z"/>
      <path className="cbarr-4" d="M65.6,104.7l7.4,8.1c0,0,4.8,0,10.7,0V94.3c17.7,2.4,34.8,12.2,34.8,19.7c0,0.2,0,0.4-0.1,0.6
