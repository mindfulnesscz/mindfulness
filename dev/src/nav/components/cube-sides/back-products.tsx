...
const BackProducts: React.FC<WmNavSubpage> = ( {homeUrl, templateUrl} ) => {
    ...
    <div id="csscube-back" className='wmcube-side'>
      ...
      <div className="css_block w_iii h_v x_o y_ii css-white product-block main-product-block">
        <a href={`${homeUrl}/alsim-cloud`}>
          <img loading="lazy" className="main-product-logo" src={`${templateUrl}/assets/images/product-logos/logo_cloud.svg`}/>
          <h4>alsim</h4>
          <h3>CLOUD</h3>
        </a>
      </div>
      <div className="css_block w_vi h_v x_iii y_ii css-white product-block main-product-block">
        <a href={`${homeUrl}/alsim-platform`}>
          <img loading="lazy" className="main-product-logo" src={`${templateUrl}/assets/images/product-logos/logo_platform.svg`} />
          <h4>alsim</h4>
          <h3>PLATFORM</h3>
        </a>
      </div>
      <div className="css_block w_iii h_v x_ix y_ii css-white product-block main-product-block">
        <a href={`${homeUrl}/alsim-services`}>
          <img loading="lazy" className="main-product-logo" src={`${templateUrl}/assets/images/product-logos/logo_services.svg`} />
          <h4>alsim</h4>
          <h3>SERVICES</h3>
        </a>
      </div>
