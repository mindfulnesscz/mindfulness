...
export default class NavbarToggle {
	constructor( elNavButton, elSideMenu, instCube, intro, ishomepage ) {
		//window.ScrollToPlugin = ScrollToPlugin;
		this.toggle = elNavButton;
		this.main_container = window;
		this.elSideMenu = elSideMenu;
		this.el_canvas = instCube.el_canvas;
		this.instCube = instCube;
		this.intro = intro;

		console.log( 'is home page is '+ishomepage);
	...
	init_type_toggle() {
		...
		this.el_type_toggle_text_el = this.el_type_toggle.getElementsByTagName(
			'span'
		)[ 0 ];
	...
	init_classic_menu() {
		...
		this.m_navbar = M.Sidenav.getInstance( this.elSideMenu );
