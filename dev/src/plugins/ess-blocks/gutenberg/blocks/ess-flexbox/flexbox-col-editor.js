...
const block = registerBlockType('mindfulness-blocks/flexbox-col', {
  ...
  edit(props) {
    ...
    const { colClass, col_xs, col_sm, col_md, col_lg, aosType } = attributes;
  ...
  save(props) {
    ...
    const { col_xs, col_sm, col_md, col_lg, aosType } = attributes;

    const colProps = {
      'data-aos': aosType != 'none' ? 'fade-' + aosType : null,
      className:
        className + ' ' +
        'col-xs-' + col_xs + ' ' +
        'col-sm-' + col_sm + ' ' +
