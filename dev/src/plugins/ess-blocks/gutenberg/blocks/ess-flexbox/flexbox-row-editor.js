...
const block = registerBlockType( 'mindfulness-blocks/flexbox-row', {
	title: 'Row Container',
	icon: 'format-image',
	category: 'layout',
	...
	edit( props ) {
		...
		return [
			...
			<div key="row-edit-key" className={ ( className, 'section mindfulness-wp-block' ) }>
				<div className="container">
					...
					>
						<InnerBlocks
							allowedBlocks={ [ 'mindfulness-blocks/flexbox-col' ] }
						/>
					</div>
				</div>
			</div>,
