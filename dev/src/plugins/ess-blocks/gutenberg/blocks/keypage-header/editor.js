...
const block = registerBlockType('mindfulness-blocks/keypage-header', {
  ...
  edit: withColors('backgroundColor')((props) => {
    ...
    const { headerType, illustration, backgroundVideoUrl } = attributes;
          ...
          <PanelBody title={'Header Settings'} initalOpen={true}>
            ...
            <PanelRow>
              <TextControl
                ...
                onChange={
                  (value) => {
                    setAttributes({ backgroundVideoUrl: value });
                  }
                }
              />
            </PanelRow>
  ...
  save(props) {
    ...
    return (
      <header id="ess-header" className={headerClasses}>
        ...
        {
          <video className='bkg-video' src={backgroundVideoUrl} autoPlay={true} loop={true} playsInline={true} muted={true} />
        }
      </header>
    );
  },
