...
<main class="ess-main has-grey-lighten-5-background-color p-top-0">
	<?php 
...
if(!empty($RunningEventsArray)):
	...
	<section class="running-section"
		style="background-image: url('<?php  echo $small[0]?>'); background-size: cover; background-position: center center;">
		<div class="container">
			<div class="row alignitems-center">
				...
				<div class="col-xs-12 col-md-6">
					<h1><a class=" mega-font"
							href="<?php echo $event_post['link']; ?>"><?php echo $event_post['title']; ?></a></h2>

						<div class="icon-headline small-icon grey-text text-lighten-1"><span class="ess-icon icon_map"></span>
							<p class="grey-text text-lighten-1 no-margin"><strong><?php echo $event_post['loc']; ?></strong></p>
						</div>
						<div class="icon-headline small-icon grey-text text-lighten-1"><span class="ess-icon icon_calendar"></span>
							<p class="grey-text text-lighten-1 no-margin"><strong><?php echo $event_post['starts']; ?> -
