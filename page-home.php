				...
				<ul id="ess-home-banner-classic" class="mind-slider">
					<li id="ess-cube-banner-its" class="slide ess-cube-banner-item">
						<a href="https://www.essteyr.com/aboutaerosols/">
							<img class="img-half" src="<?php echo home_url().'/ess-media/home-banner/210617_environment/environment_cube_whole.jpg'?>">
							<div class="banner-text-part">
								<h3>#aboutaerosols</h3>
								<p>Find out how aerosols behave and how to mitigate risks posed by them!</p>
								<div class="dark big-button ess-button">enter</div>
							</div>
						</a>
					</li>
				</ul>
