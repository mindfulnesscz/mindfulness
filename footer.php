...
?>
        ...
        <div id="ess-side-contact" class="sidenav">
            <!-- <div class="bkg-semi-transparent"></div> -->
            <div id="ess-side-contact-form-holder">
                <h2>HAVING QUESTIONS OR NOTES? <br>PLEASE LET US KNOW</h2>
