...
<a class="banner-button block h-full" style="text-decoration: none" href="<?php echo home_url() . '/ess-events/lange-nacht-der-forschung-long-night-of-research'; ?>">
  <div class="row m-bot-zero h-full" style="background-color: #001431;">
    <div class="col-xs-6 p-left-double flex alignitems-center wrap h-full z-10">
